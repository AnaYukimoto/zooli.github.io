    ...
    <section class="vitrine1">
        ...
        <ul class="product-list">
            <li class="product-item">
                <a href="login.php" target="_blank" class="product-link">
...
<!-- FINAL DAS PERGUNTAS FREQUENTES -->
  ...
  <footer class="site-footer">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <h6>SOBRE NÓS</h6>
            <p class="text-justify">A Zooli é uma plataforma digital dedicada ao ramo pet e se destaca por fornecer uma ampla variedade de produtos e serviços exclusivos através da nossa plataforma intuitiva. Com apenas alguns cliques, os tutores podem encontrar hospedagem confiável para seus pets, cuidados profissionais e passeios divertidos. Além disso, nos preocupamos com a segurança dos animais, selecionando cuidadores experientes e qualificados!</p>
          </div>
          ...
          <div class="col-xs-6 col-md-3">
            <h6>LINK RÁPIDOS</h6>
            <ul class="footer-links">
              <li><a href="#sobre">Sobre a Zooli</a></li>
              <li><a href="contato.php">Contato</a></li>
      ...
      <div class="container">
        <div class="row">
            <p class="copyright-text">Copyright © 2023, Direitos Reservados pelo Grupo Tcc Zooli.</p>
            <br>
            <div class="icones">
                <div class="icone">
                ...
                <div class="icone">
                    <img src="img/icones/gmail.png" alt="wats" class="contactimg">
                </div>
            </div>
        </div>
      </div>
