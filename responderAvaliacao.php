...
// Cria a conexão
$conn = mysqli_connect('localhost', 'id20884837_root', 'Zooli+pets123', 'id20884837_dbpets');
...
if ($result->num_rows > 0) {
  ...
  <div id="formulario-container" style="display:none;">
    ...
    <form id="formulario" action="responderAvaliacao.php?valor=enviado" method="post">
