...
<h2 style="color:black">Messagens a Serem Respondidas:</h2> <br>
<?php
  ...
  <div id="formulario-container" style="display:none;">
    ...
    <form id="formulario" action="respondermessage.php?valor=enviado" method="post">
      ...
      <div class="input-group">
          ...
          <input type="email" id="email" name="email" placeholder="Seu e-mail" Readonly >
      </div>
      <div class="input-group">
          <label>Mensagem do Cliente:</label>
          <input type="text" id="assunto" name="assunto" placeholder="Assunto" Readonly >
      </div>
      <div class="input-group">
          <label> Sua Mensagem de Resposta:</label>
          <input id="mensagem" name="mensagem" placeholder="Sua mensagem" required>
      </div>
...
$servername = "localhost";
$username = "id20884837_root";
$password = "Zooli+pets123";
$dbname = "id20884837_dbpets";
