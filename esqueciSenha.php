...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$email = isset($_POST['emailCliente']) ? $_POST['emailCliente'] : "";
	...
	if (mysqli_num_rows($resultado) == 1) {
		...
		$link = "https://zoolisite.000webhostapp.com/redefinirSenha.php?email=$email&token=$token";
	    ...
	    echo "E-mail enviado com sucesso! Agora verifique seu e-mail pois um link de redefinição de senha foi enviado para ele";
